package by.bsuir.carapp.ui.screens.home
...
import by.bsuir.carapp.R
import by.bsuir.carapp.navigation.Routes
import by.bsuir.carapp.navigation.Routes.HOME
import by.bsuir.carapp.navigation.Routes.SIGN_IN
import by.bsuir.carapp.services.AuthenticationService
import by.bsuir.carapp.ui.theme.accentColor
import by.bsuir.carapp.ui.theme.backgroundColor
import by.bsuir.carapp.ui.theme.primaryColor
import by.bsuir.carapp.ui.theme.textColor
import by.bsuir.carapp.viewmodel.SettingsViewModel
...
fun SettingsScreen(viewModel: SettingsViewModel, navController: NavHostController) {
    ...
    if (userData != null) {
        ...
        var carCountry by remember { mutableStateOf(userData.carCountry ?: "") }
        var carBody by remember { mutableStateOf(userData.carBody ?: "") }
        var carDrive by remember { mutableStateOf(userData.carDrive ?: "") }
        var carTransmission by remember { mutableStateOf(userData.transmission ?: "") }
                            ...
                            Column(
                                ...
                                Row(
                                    ...
                                    Row(
                                        ...
                                        Box(
                                            ...
                                            CountryFlagImage(country = carCountry)
                                        }
                                        Spacer(Modifier.width(10.dp))
                                        Text(
                                            text = Locale("", carCountry).getDisplayCountry(
                                                Locale(
                                                    carCountry
                                                )
                                            ),
                                ...
                                Row(verticalAlignment = Alignment.CenterVertically) {
                                    ...
                                    ExposedDropdownMenuBox(
                                        expanded = expandedCarBody,
                                        onExpandedChange = {
                                            expandedCarBody = !expandedCarBody
                                        }
                                    ) {
                                        TextField(
                                            value = (carBody.ifEmpty { "Нет предпочтений" }),
                                            onValueChange = {},
                                            readOnly = true,
                                            trailingIcon = {
                                        ...
                                        ExposedDropdownMenu(
                                            expanded = expandedCarBody,
                                            onDismissRequest = { expandedCarBody = false }
                                        ) {
                                            carBodyTypes.forEach { item ->
                                                DropdownMenuItem(
                                                    text = {
                                                        Text(
                                                            text = item.ifEmpty { "Нет предпочтений" },
                                                            fontSize = 16.sp,
                                                            fontWeight = FontWeight.Bold
                                                        )
                                                    },
                                ...
                                Row(verticalAlignment = Alignment.CenterVertically) {
                                    ...
                                    ExposedDropdownMenuBox(
                                        expanded = expandedCarDrive,
                                        onExpandedChange = {
                                            expandedCarDrive = !expandedCarDrive
                                        }
                                    ) {
                                        TextField(
                                            value = (carDrive.ifEmpty { "Нет предпочтений" }),
                                            onValueChange = {},
                                            readOnly = true,
                                            textStyle = TextStyle(
                                                fontSize = 16.sp,
                                        ...
                                        ExposedDropdownMenu(
                                            expanded = expandedCarDrive,
                                            onDismissRequest = { expandedCarDrive = false }
                                        ) {
                                            carDriverTypes.forEach { item ->
                                                DropdownMenuItem(
                                                    text = {
                                                        Text(
                                                            text = item.ifEmpty { "Нет предпочтений" },
                                ...
                                Row(verticalAlignment = Alignment.CenterVertically) {
                                    ...
                                    ExposedDropdownMenuBox(
                                        expanded = expandedCarTransmission,
                                        onExpandedChange = {
                                            expandedCarTransmission = !expandedCarTransmission
                                        }
                                    ) {
                                        TextField(
                                            value = (carTransmission.ifEmpty { "Нет предпочтений" }),
                                            onValueChange = {},
                                            readOnly = true,
                                            textStyle = TextStyle(
                                                fontSize = 16.sp,
                                        ...
                                        ExposedDropdownMenu(
                                            expanded = expandedCarTransmission,
                                            onDismissRequest = { expandedCarTransmission = false }
                                        ) {
                                            transmissionTypes.forEach { item ->
                                                DropdownMenuItem(
                                                    ...
                                                    onClick = {
                                                        carTransmission = item
                                                        expandedCarTransmission = false
                                                    }
                                                )
                                            }
                                        }
